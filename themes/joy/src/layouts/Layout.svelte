...
/* Hero */
.hero { position: relative; overflow: hidden; padding: 96px 0 140px; color: #fff; background: linear-gradient(150deg, var(--primary) 0%, var(--secondary) 100%); }
...
.news-badge { display: inline-block; align-self: flex-start; background: color-mix(in srgb, var(--secondary) 18%, transparent); color: color-mix(in srgb, var(--secondary) 55%, #3d0018); font-size: 11px; font-weight: 700; letter-spacing: .03em; text-transform: uppercase; padding: 5px 12px; border-radius: 999px; margin-bottom: 14px; }
...
.footer-bottom { border-top: 1px solid #241a3a; padding-top: 20px; font-size: 13px; color: #64748b; }
`;
</script>
