<script>
	/**
	 * Renders `core.news` with this theme's card style (featured image, date
	 * meta) — the same markup its home layout uses, from live `news` rather
	 * than props, so the section stays current after authoring.
	 */
