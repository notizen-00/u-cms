/**
 * Vanilla JS, no dependencies: intercepts submit on any `.cms-form-embed`
 * (rendered by EtaSiteRenderer from a `cms-form` block — see
 * apps/backend/src/modules/builder/render/eta-site-renderer.ts), POSTs JSON
 * to the form's `action` (the backend's public submit endpoint), and swaps
 * in the success/error message inline instead of navigating away.
 */
